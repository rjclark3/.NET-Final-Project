Public Class frmAddNewGolfer
    Private Sub frmAddNewGolfer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSubmit_Click_1(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        If Validation() = True Then
            ...
            End If
            strSelect = "SELECT MAX(intGolferEventYearID) + 1 AS intNextHighestRecordID2 FROM TGolferEventYears"
            ...
            Else
                ...
                'No, get the next highest ID
                intNextHighestRecordID2 = CInt(drSourceTable.Item(0))

            End If

            strInsert = "Insert into TGolferEventYears ( intGolferEventYearID, intGolferID, intEventYearID )" &
                " Values (" & intNextHighestRecordID2 & "," & intNextHighestRecordID & "," & cboEvents.SelectedValue & ")"
            ...
            If intRowsAffected > 0 Then
                MessageBox.Show(strFirstName & "' '" & strLastName & " has been added to the " & cboEvents.SelectedValue & " event.")
                Me.Close()
            End If
